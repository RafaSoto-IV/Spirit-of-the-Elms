class FamiliarSceneThree extends Phaser.Scene {

    constructor(){
        super({ key: 'FamiliarSceneThree'});
    ...
    create(){
      ...
      update(){
        ...
        if(this.progress == 1){
          console.log("prog1");
          this.dialogText.setText("The yellow familiar lends you \n the power of the \n DEMON'S STUN.");
